...
we have `0` as our `acc` and the list `[1;2;3;4;5]` as our starting list.

| Step | Description |
|:----|:--------|
| match on []    | No, we didn't reach the end |
| match on x::xs | Yes, `1::[2;3;4;5]`
| executing      | `f 0 1 (fun lacc -> foldk f lacc [2;3;4;5])` |
| `k (0 + 1)`    | executing: `foldk f 1 [2;3;4;5]` |
| match on []    | No |
| match on x::xs | Yes, `2::[3;4;5]` |
| executing      | `f 1 2 (fun lacc -> foldk f lacc [3;4;5])` |
| `k (1 + 2)`    | executing: `foldk f 3 [3;4;5]` |
| match on []    | No |
| match on x::xs | Yes, `3::[4;5]` |
| executing      | `f 3 3 (fun lacc -> foldk f lacc [4;5])` |
| `k (3 + 3)`    | executing: `foldk f 6 [4;5]` |
| match on []    | No |
| match on x::xs | Yes, `4::[5]` |
| executing      | `f 6 4 (fun lacc -> foldk f lacc [5])` |
| `k (6 + 4)`    | executing: `foldk f 10 [5]` |
| match on []    | No |
| match on x::xs  | Yes, `5::[]` |
| executing       | `f 10 5 (fun lacc -> foldk f lacc [])` |
| `k (10 + 5)`    | executing: `foldk f 15 []` |
| match on []     | Yes |
| returning `acc` | 15 |

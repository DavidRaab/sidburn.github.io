...
(**
I already wrote [an article that explains immutability]({% post_url 2016-03-14-immutability-and-pure-functions %}),
...
we write code either into a more sequential-style or a nested-style]({% post_url 2016-09-25-function-application-and-composition %})

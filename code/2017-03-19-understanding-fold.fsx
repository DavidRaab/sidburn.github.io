...
[Structured Programming]({% post_url 2016-03-09-structured-programming %}).
...
[Catamorphisms]({% post_url 2016-05-28-catamorphisms %}). You should
know about [Algebraic Data-Types]({% post_url 2016-04-26-algebraic-data-types %})
